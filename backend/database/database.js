...
//const mongoUrl = `mongodb://${process.env.MONGO_USERNAME}:${process.env.MONGO_PASSWORD}@cluster0-shard-00-00.5oa06.mongodb.net:27017,cluster0-shard-00-01.5oa06.mongodb.net:27017,cluster0-shard-00-02.5oa06.mongodb.net:27017/${process.env.MONGO_DATABASE}?ssl=true&replicaSet=atlas-lruunc-shard-0&authSource=admin&retryWrites=true&w=majority`;
